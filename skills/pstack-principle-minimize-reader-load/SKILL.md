...
---
Sourced from `cursor/plugins/pstack/skills/principle-minimize-reader-load`. References `principle-guard-the-context-window` (installed alongside this one) as an analogy, not a hard dependency.
