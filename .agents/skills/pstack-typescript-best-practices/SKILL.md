...
---
Sourced from `cursor/plugins/pstack/skills/typescript-best-practices`. Depends on this install's `pstack-principle-type-system-discipline` (apply first) and `pstack-principle-boundary-discipline` (boundary validation row) — both installed alongside this skill.
