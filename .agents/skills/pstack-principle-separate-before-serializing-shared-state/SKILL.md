...
---
Sourced from `cursor/plugins/pstack/skills/principle-separate-before-serializing-shared-state`. Self-contained, no dependencies. Especially relevant to this install's parallel-subagent / git-worktree delegation patterns.
